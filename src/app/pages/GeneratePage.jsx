      ...
      <div className="max-w-2xl w-full bg-white rounded-2xl shadow-lg p-8">
        ...
        <div className="space-y-3 mb-8">
          <div className={`flex items-center gap-3 p-3 rounded-lg ${
            progress >= 30 ? "bg-green-50" 
          }`}>
            <Brain className={`w-5 h-5 ${progress >= 30 ? "text-green-600" }`} />
            <span className={progress >= 30 ? "text-green-900" }>
              PDF 내용 분석
            </span>
          </div>
          <div className={`flex items-center gap-3 p-3 rounded-lg ${
            progress >= 60 ? "bg-green-50" 
          }`}>
            <Sparkles className={`w-5 h-5 ${progress >= 60 ? "text-green-600" }`} />
            <span className={progress >= 60 ? "text-green-900" }>
              문제 생성
            </span>
          </div>
          <div className={`flex items-center gap-3 p-3 rounded-lg ${
            ...
            <CheckCircle className={`w-5 h-5 ${progress >= 100 ? "text-green-600" }`} />
            <span className={progress >= 100 ? "text-green-900" }>
              완료
            </span>
          </div>
        </div>
